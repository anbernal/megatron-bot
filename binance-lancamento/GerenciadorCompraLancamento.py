...
from GerenciadorMoedasLancamento import GerenciadorMoedasLancamento
...
class GerenciadorCompraLancamento:
    ...
    def run(self):
        ...
        gerenciador = GerenciadorMoedasLancamento(DATABASE_ADDRESS)
                ...
                if moedas:
                    for nome_moeda in moedas:
                        ...
                        if balance >= minimum_balance:
                            compradorBinance.comprar(nome_moeda)
